...
GO
/*
The type for column IdentityId in table [dbo].[UserProfile] is currently  TEXT NULL but is being changed to  UNIQUEIDENTIFIER NULL. There is no implicit or explicit conversion.
*/
